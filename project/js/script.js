(function($) {
	...
	if($('.main-slider .main-slider-carousel .slide .auto-container .clearfix .content .open').length){
		//Show Form
		$('.main-slider .main-slider-carousel .slide .auto-container .clearfix .content .open').on('click', function(e) {
			e.preventDefault();
			$('body').addClass('appointment-form-visible');
		});
		//Hide Form
