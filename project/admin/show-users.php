            ...
            <div class="table-responsive">
								  	<table class="table mb-0">
										<tbody>
											...
											<tr>
                                            <?PHP 
                                            $select = "SELECT DISTINCT * FROM `appointment` AS A JOIN users AS U ON U.ID = A.USER_ID ";
                                            ...
                                            <?php if($show['GENDER']==0){
                                              ...
                                              <td><a href="../profile.php?id=<?php echo $show['ID'] ?>"><i  class="h3 bi bi-person-fill"></i></a></td>
