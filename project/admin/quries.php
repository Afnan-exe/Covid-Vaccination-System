	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h3 class="page-title">QURIES</h3>
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="dashboard.php"><i class="mdi mdi-home-outline"></i></a></li>
								<li class="breadcrumb-item active" aria-current="page">Quries From Paitent</li>
							</ol>
						</nav>
					</div>
				</div>
								  	...
								  	<table class="table mb-0">
										<thead>
                                            ...
                                            ?>
											  ...
											  <td><?php echo $show['HOSPITAL'] ?></td>
                                              <td><?php echo $show['MESSAGE'] ?></td>
											  <td>
												  <div class="d-flex">
												  
													  <a href="query-delete.php?id=<?php echo $show['ID'] ?>" class="waves-effect waves-circle btn btn-circle btn-danger btn-xs"><i class="fa fa-trash"></i></a>
												  </div>
											  </td>
											</tr>
